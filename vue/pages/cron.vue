...
const data = ref([{
    key: 0,
    name: "备份rupa数据库",
    type: "database", // 数据库备份操作
    cron: " 0 0 * * *", // 每天凌晨0点执行； 分时秒月周的经典设计
    num: 3, // 保留份数
    update: "2021-10-10 10:10:10", // 上次执行时间
    backup_to: "rupa123", // 备份位置
    log: "相关代码执行命令结果(如有)", // 默认格式：时间+执行命令+执行结果[成功与否]
}, {
    key: 1,
    name: "备份rupa数据库2",
    type: "database",
